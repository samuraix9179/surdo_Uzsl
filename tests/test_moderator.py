"""Tests for moderator utility functions."""
import sys
import os
...
def test_analyze_video_quality_sync_valid(mock_exists):
    ...
    """Verify analyze_video_quality_sync handles valid videos correctly."""
...
def test_analyze_video_quality_sync_invalid_face(mock_exists):
    # Setup cv2.VideoCapture mock
    """Verify analyze_video_quality_sync rejects videos without face visibility."""
    cap_inst = mock_cv2.VideoCapture.return_value

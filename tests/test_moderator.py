"""Tests for the video quality moderator functionality."""
import sys
import os
...
def test_analyze_video_quality_sync_valid(mock_exists):
    """Verify analyze_video_quality_sync on valid video."""
...
def test_analyze_video_quality_sync_invalid_face(mock_exists):
    """Verify analyze_video_quality_sync returns correct error code for invalid face."""
    # Setup cv2.VideoCapture mock
    cap_inst = mock_cv2.VideoCapture.return_value

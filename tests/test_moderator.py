"""Tests for moderation queue and processing workflows."""
import sys
import os
...
def test_analyze_video_quality_sync_valid(mock_exists):
    """Verify sync analysis recognizes valid video quality."""
...
def test_analyze_video_quality_sync_invalid_face(mock_exists):
    """Verify sync analysis rejects video with missing or obscured face."""
    # Setup cv2.VideoCapture mock
    cap_inst = mock_cv2.VideoCapture.return_value

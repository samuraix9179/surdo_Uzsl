"""Tests for the video moderator functionality."""
import sys
import os
...
def test_analyze_video_quality_sync_valid(mock_exists):
    """Verify video quality analysis handles valid input correctly."""
...
def test_analyze_video_quality_sync_invalid_face(mock_exists):
    """Verify video quality analysis correctly flags missing face landmarks."""
    # Setup cv2.VideoCapture mock
    cap_inst = mock_cv2.VideoCapture.return_value

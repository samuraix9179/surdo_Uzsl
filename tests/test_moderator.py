"""Tests for the video moderator logic."""
import sys
import os
...
def test_analyze_video_quality_sync_valid(mock_exists):
    """Verify analyze_video_quality_sync accepts valid face/hand presence."""
...
def test_analyze_video_quality_sync_invalid_face(mock_exists):
    """Verify analyze_video_quality_sync rejects insufficient face presence."""
    # Setup cv2.VideoCapture mock
    cap_inst = mock_cv2.VideoCapture.return_value

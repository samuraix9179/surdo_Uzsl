"""Tests for the validate_agent_tasks script."""
import pytest
...
def test_invalid_schema_version(valid_manifest):
    """Test that invalid schema_version raises an error."""
...
def test_empty_tasks(valid_manifest):
    """Test that empty tasks raises an error."""
...
def test_duplicate_task_id(valid_manifest):
    """Test that duplicate task id raises an error."""

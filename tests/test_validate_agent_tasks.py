...
def test_missing_schema_version(valid_manifest):
    """Test that a missing schema_version raises ValueError."""
...
def test_invalid_schema_version(valid_manifest):
    """Test that an invalid schema_version raises ValueError."""
...
def test_missing_tasks(valid_manifest):
    """Test that a missing tasks array raises ValueError."""
...
def test_empty_tasks(valid_manifest):
    """Test that an empty tasks array raises ValueError."""
...
def test_invalid_task_status(valid_manifest):
    """Test that an invalid task status raises ValueError."""
...
def test_missing_task_fields(valid_manifest):
    """Test that missing mandatory task fields raises ValueError."""

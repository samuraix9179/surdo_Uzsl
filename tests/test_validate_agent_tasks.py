"""Unit tests for validating the agent_tasks.json manifest schema."""
...
def test_invalid_schema_version(valid_manifest):
    """Test test_invalid_schema_version function."""
...
def test_missing_tasks(valid_manifest):
    """Test test_missing_tasks function."""
...
def test_empty_tasks(valid_manifest):
    """Test test_empty_tasks function."""
...
def test_invalid_task_status(valid_manifest):
    """Test test_invalid_task_status function."""
...
def test_missing_task_fields(valid_manifest):
    """Test test_missing_task_fields function."""
...
def test_duplicate_task_id(valid_manifest):
    """Test test_duplicate_task_id function."""

"""Tests for the agent tasks manifest validation script."""
...
def test_missing_schema_version(valid_manifest):
    """Test validation fails if schema_version is missing."""
...
def test_invalid_schema_version(valid_manifest):
    """Test validation fails if schema_version is invalid."""
...
def test_missing_tasks(valid_manifest):
    """Test validation fails if tasks key is missing."""
...
def test_empty_tasks(valid_manifest):
    """Test validation fails if tasks array is empty."""
...
def test_invalid_task_status(valid_manifest):
    """Test validation fails with invalid task status."""
...
def test_missing_task_fields(valid_manifest):
    """Test validation fails if required task fields are missing."""
...
def test_duplicate_task_id(valid_manifest):
    """Test validation fails if task IDs are not unique."""

"""Unit tests for agent_tasks.json validation."""
...
@pytest.fixture
def valid_manifest():
    """Provide a valid tasks manifest fixture."""
    return {
        "schema_version": 1,
        "project": "surdo",
...
def test_missing_schema_version(valid_manifest):
    """Test missing schema_version raises error."""
...
def test_missing_tasks(valid_manifest):
    """Test missing tasks array raises error."""
...
def test_missing_task_fields(valid_manifest):
    """Test missing required task fields raises error."""
...
def test_duplicate_task_id(valid_manifest):
    """Test duplicate task IDs raises error."""

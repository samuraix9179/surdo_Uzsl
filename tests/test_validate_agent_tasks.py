"""Tests for the agent tasks validation script."""
import pytest
...
def test_missing_tasks(valid_manifest):
    """Test validation fails when tasks are missing."""
...
def test_empty_tasks(valid_manifest):
    """Test validation fails when tasks array is empty."""
...
def test_duplicate_task_id(valid_manifest):
    """Test validation fails when there are duplicate task IDs."""

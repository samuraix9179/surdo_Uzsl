"""Tests for validating agent_tasks.json schema."""
...
@pytest.fixture
def valid_manifest():
    """Return a properly structured agent tasks manifest for testing."""
    return {
        "schema_version": 1,
        "project": "surdo",
...
def test_valid_manifest(valid_manifest):
    """Verify a correct manifest passes validation with no errors."""
    warnings = validate_manifest(valid_manifest)
    assert isinstance(warnings, list)


def test_missing_schema_version(valid_manifest):
    """Verify validation fails if schema_version is missing."""
...
def test_invalid_schema_version(valid_manifest):
    """Verify validation fails if schema_version is incorrect."""
...
def test_missing_tasks(valid_manifest):
    """Verify validation fails if tasks array is missing."""
...
def test_empty_tasks(valid_manifest):
    """Verify validation fails if tasks array is empty."""
...
def test_invalid_task_status(valid_manifest):
    """Verify validation fails on unknown task status."""

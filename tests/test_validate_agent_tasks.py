"""Tests for validation of agent_tasks.json schema."""
import pytest
...
@pytest.fixture
def valid_manifest():
    """Return a valid agent manifest fixture for testing."""
    return {
        "schema_version": 1,
        "project": "surdo",
...
def test_missing_schema_version(valid_manifest):
    """Test that a missing schema version fails validation."""
...
def test_missing_tasks(valid_manifest):
    """Test that missing tasks fails validation."""
...
def test_empty_tasks(valid_manifest):
    """Test that empty tasks fails validation."""
...
def test_invalid_task_status(valid_manifest):
    """Test that invalid task status fails validation."""
...
def test_missing_task_fields(valid_manifest):
    """Test that missing required task fields fails validation."""
...
def test_duplicate_task_id(valid_manifest):
    """Test that duplicate task ids fails validation."""

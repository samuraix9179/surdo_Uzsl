...
@pytest.fixture
def valid_manifest():
    """Provide valid_manifest for testing."""
    return {
        "schema_version": 1,
        "project": "surdo",
...
def test_invalid_schema_version(valid_manifest):
    """Verify test invalid schema version."""
...
def test_invalid_task_status(valid_manifest):
    """Verify test invalid task status."""
...
def test_missing_task_fields(valid_manifest):
    """Verify test missing task fields."""

"""Test suite for validate_agent_tasks functionality."""
import pytest
...
@pytest.fixture
def valid_manifest():
    """Provide a valid base task manifest fixture."""
    return {
        "schema_version": 1,
        "project": "surdo",
...
def test_valid_manifest(valid_manifest):
    """Verify a well-formed manifest passes validation."""
...
def test_invalid_schema_version(valid_manifest):
    """Verify validation fails for an incorrect schema version."""
...
def test_invalid_task_status(valid_manifest):
    """Verify validation fails for an unrecognized task status."""
...
def test_duplicate_task_id(valid_manifest):
    """Verify validation fails when task IDs are duplicated."""

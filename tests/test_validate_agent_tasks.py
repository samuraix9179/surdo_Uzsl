"""Unit tests for agent task manifest validation."""
...
@pytest.fixture
def valid_manifest():
    """Fixture to provide a valid task manifest."""
    return {
        "schema_version": 1,
        "project": "surdo",
...
def test_missing_tasks(valid_manifest):
    """Verify validation fails when tasks field is missing."""
...
def test_invalid_task_status(valid_manifest):
    """Verify validation fails when a task status is invalid."""

"""Tests for validating the agent task manifest schema."""
import pytest
...
@pytest.fixture
def valid_manifest():
    """Provide a valid task manifest for testing."""
    return {
        "schema_version": 1,
        "project": "surdo",
...
def test_missing_schema_version(valid_manifest):
    """Test that validation fails when schema_version is missing."""
...
def test_invalid_schema_version(valid_manifest):
    """Test that validation fails when schema_version is invalid."""
...
def test_missing_tasks(valid_manifest):
    """Test that validation fails when tasks list is missing."""
...
def test_empty_tasks(valid_manifest):
    """Test that validation fails when tasks list is empty."""
...
def test_invalid_task_status(valid_manifest):
    """Test that validation fails when task status is invalid."""
...
def test_missing_task_fields(valid_manifest):
    """Test that validation fails when a task is missing required fields."""
...
def test_duplicate_task_id(valid_manifest):
    """Test that validation fails when duplicate task IDs exist."""

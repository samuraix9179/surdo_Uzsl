"""Test module for validate_agent_tasks script."""
import pytest
...
def test_missing_schema_version(valid_manifest):
    """Verify that missing schema_version raises an error."""
...
def test_missing_task_fields(valid_manifest):
    """Verify that missing required task fields raise an error."""
...
def test_duplicate_task_id(valid_manifest):
    """Verify that a duplicate task ID raises an error."""

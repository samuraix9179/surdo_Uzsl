"""Test cases for agent_tasks.json validation."""
import pytest
...
@pytest.fixture
def valid_manifest():
    """Return a valid agent_tasks.json dictionary for testing."""
    return {
        "schema_version": 1,
        "project": "surdo",
...
def test_valid_manifest(valid_manifest):
    """Test that a well-formed manifest passes validation."""
    warnings = validate_manifest(valid_manifest)
    assert isinstance(warnings, list)


def test_missing_schema_version(valid_manifest):
    """Test validation failure when schema_version is missing."""
...
def test_invalid_schema_version(valid_manifest):
    """Test validation failure on unsupported schema_version."""
...
def test_missing_tasks(valid_manifest):
    """Test validation failure when tasks array is absent."""
...
def test_empty_tasks(valid_manifest):
    """Test validation failure when tasks array is empty."""
...
def test_invalid_task_status(valid_manifest):
    """Test validation failure on an invalid task status."""
...
def test_missing_task_fields(valid_manifest):
    """Test validation failure if a task is missing mandatory fields."""
...
def test_duplicate_task_id(valid_manifest):
    """Test validation failure when duplicate task IDs exist."""

...
@pytest.fixture
def valid_manifest():
    """Return a valid agent tasks manifest fixture."""
    return {
        "schema_version": 1,
        "project": "surdo",
...
def test_valid_manifest(valid_manifest):
    """Verify that a valid manifest passes validation without raising an error."""
    warnings = validate_manifest(valid_manifest)
    assert isinstance(warnings, list)


def test_missing_schema_version(valid_manifest):
    """Verify that a missing schema_version raises a ValidationError."""
...
def test_invalid_schema_version(valid_manifest):
    """Verify that an invalid schema_version raises a ValidationError."""
...
def test_missing_tasks(valid_manifest):
    """Verify that missing tasks array raises a ValidationError."""

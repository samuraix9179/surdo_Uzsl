"""Test suite for test_validate_agent_tasks.py."""
import pytest
...
@pytest.fixture
def valid_manifest():
    """Return a valid manifest fixture."""
    return {
        "schema_version": 1,
        "project": "surdo",
...
def test_missing_schema_version(valid_manifest):
    """Test manifest validation with missing schema version."""
...
def test_missing_tasks(valid_manifest):
    """Test manifest validation with missing tasks list."""
...
def test_empty_tasks(valid_manifest):
    """Test manifest validation with empty tasks list."""
...
def test_invalid_task_status(valid_manifest):
    """Test manifest validation with invalid task status."""
...
def test_missing_task_fields(valid_manifest):
    """Test manifest validation with missing required task fields."""
...
def test_duplicate_task_id(valid_manifest):
    """Test manifest validation with duplicate task IDs."""

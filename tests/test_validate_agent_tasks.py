"""Tests for agent tasks validation."""
import pytest
...
@pytest.fixture
def valid_manifest():
    """Provide a valid agent tasks manifest for testing."""
    return {
        "schema_version": 1,
        "project": "surdo",
...
def test_invalid_schema_version(valid_manifest):
    """Test validation fails when schema_version is not supported."""
...
def test_invalid_task_status(valid_manifest):
    """Test validation fails when task status is invalid."""
...
def test_missing_task_fields(valid_manifest):
    """Test validation fails when a required task field is missing."""
...
def test_duplicate_task_id(valid_manifest):
    """Test validation fails when duplicate task IDs are present."""

...
@pytest.fixture
def valid_manifest():
    """Verify valid manifest functionality."""
    return {
        "schema_version": 1,
        "project": "surdo",
...
def test_invalid_schema_version(valid_manifest):
    """Verify test invalid schema version functionality."""
...
def test_missing_tasks(valid_manifest):
    """Verify test missing tasks functionality."""
...
def test_empty_tasks(valid_manifest):
    """Verify test empty tasks functionality."""
...
def test_invalid_task_status(valid_manifest):
    """Verify test invalid task status functionality."""
...
def test_missing_task_fields(valid_manifest):
    """Verify test missing task fields functionality."""
...
def test_duplicate_task_id(valid_manifest):
    """Verify test duplicate task id functionality."""

"""Test module for validating agent tasks manifest schema."""
import pytest
...
@pytest.fixture
def valid_manifest():
    """Provide a valid agent tasks manifest dictionary for testing."""
    return {
        "schema_version": 1,
        "project": "surdo",
...
def test_valid_manifest(valid_manifest):
    """Verify that a correct manifest is validated successfully."""
    warnings = validate_manifest(valid_manifest)
    assert isinstance(warnings, list)


def test_missing_schema_version(valid_manifest):
    """Verify that a manifest without schema_version raises ValueError."""
...
def test_invalid_schema_version(valid_manifest):
    """Verify that a manifest with unsupported schema_version raises ValueError."""
...
def test_missing_tasks(valid_manifest):
    """Verify that a manifest missing the tasks key raises ValueError."""
...
def test_empty_tasks(valid_manifest):
    """Verify that a manifest with an empty tasks list raises ValueError."""
...
def test_invalid_task_status(valid_manifest):
    """Verify that tasks with invalid status values raise ValueError."""
...
def test_missing_task_fields(valid_manifest):
    """Verify that tasks missing required fields raise ValueError."""
...
def test_duplicate_task_id(valid_manifest):
    """Verify that a manifest with duplicate task IDs raises ValueError."""

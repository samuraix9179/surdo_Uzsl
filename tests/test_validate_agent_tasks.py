"""Unit tests for validating the agent tasks JSON manifest."""
...
def test_invalid_schema_version(valid_manifest):
    """Test validation with an invalid schema_version."""
...
def test_missing_tasks(valid_manifest):
    """Test validation when tasks array is missing."""
...
def test_invalid_task_status(valid_manifest):
    """Test validation with an invalid task status."""
...
def test_missing_task_fields(valid_manifest):
    """Test validation when required task fields are missing."""
...
def test_duplicate_task_id(valid_manifest):
    """Test validation when duplicate task IDs exist."""

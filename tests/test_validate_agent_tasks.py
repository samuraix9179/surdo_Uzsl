...
@pytest.fixture
def valid_manifest():
    """Return a valid task manifest for testing."""
    return {
        "schema_version": 1,
        "project": "surdo",
...
def test_valid_manifest(valid_manifest):
    """Verify validation passes for a valid manifest."""
...
def test_invalid_schema_version(valid_manifest):
    """Verify validation fails with an invalid schema version."""
...
def test_empty_tasks(valid_manifest):
    """Verify validation fails with an empty tasks list."""
...
def test_invalid_task_status(valid_manifest):
    """Verify validation fails with an invalid task status."""
...
def test_missing_task_fields(valid_manifest):
    """Verify validation fails when mandatory task fields are missing."""
...
def test_duplicate_task_id(valid_manifest):
    """Verify validation fails with duplicate task IDs."""

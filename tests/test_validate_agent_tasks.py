"""Module containing tests for test_validate_agent_tasks."""
import pytest
...
@pytest.fixture
def valid_manifest():
    """Return valid manifest for testing."""
    return {
        "schema_version": 1,
        "project": "surdo",
...
def test_missing_schema_version(valid_manifest):
    """Test test_missing_schema_version."""
...
def test_invalid_schema_version(valid_manifest):
    """Test test_invalid_schema_version."""

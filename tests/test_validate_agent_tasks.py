"""Tests for the validate_agent_tasks module."""
import pytest
...
def test_valid_manifest(valid_manifest):
    """Test that a valid manifest parses successfully."""
    warnings = validate_manifest(valid_manifest)
    assert isinstance(warnings, list)


def test_missing_schema_version(valid_manifest):
    """Test that missing schema version raises an error."""
...
def test_invalid_schema_version(valid_manifest):
    """Test that invalid schema version raises an error."""
...
def test_empty_tasks(valid_manifest):
    """Test that empty tasks list raises an error."""
...
def test_invalid_task_status(valid_manifest):
    """Test that invalid task status raises an error."""
...
def test_missing_task_fields(valid_manifest):
    """Test that missing task fields raises an error."""
...
def test_duplicate_task_id(valid_manifest):
    """Test that duplicate task ids raises an error."""

"""Test suite for test_validate_agent_tasks."""
import pytest
...
@pytest.fixture
def valid_manifest():
    """Return a valid manifest object."""
    return {
        "schema_version": 1,
        "project": "surdo",
...
def test_valid_manifest(valid_manifest):
    """Test a valid manifest is parsed without errors."""
    warnings = validate_manifest(valid_manifest)
    assert isinstance(warnings, list)


def test_missing_schema_version(valid_manifest):
    """Test manifest missing schema version raises ValidationError."""
...
def test_invalid_schema_version(valid_manifest):
    """Test manifest with invalid schema version raises ValidationError."""
...
def test_missing_tasks(valid_manifest):
    """Test manifest missing tasks raises ValidationError."""
...
def test_empty_tasks(valid_manifest):
    """Test manifest with empty tasks raises ValidationError."""
...
def test_invalid_task_status(valid_manifest):
    """Test manifest with invalid task status raises ValidationError."""
...
def test_missing_task_fields(valid_manifest):
    """Test manifest with missing required task fields raises ValidationError."""
...
def test_duplicate_task_id(valid_manifest):
    """Test manifest with duplicate task IDs raises ValidationError."""

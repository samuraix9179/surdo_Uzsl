"""Tests for validating the agent tasks manifest."""
...
def test_missing_schema_version(valid_manifest):
    """Test that missing schema_version raises an error."""
...
def test_invalid_schema_version(valid_manifest):
    """Test that an invalid schema_version raises an error."""
...
def test_empty_tasks(valid_manifest):
    """Test that empty tasks array raises an error."""
...
def test_invalid_task_status(valid_manifest):
    """Test that an invalid task status raises an error."""
...
def test_duplicate_task_id(valid_manifest):
    """Test that a duplicate task ID raises an error."""

"""Tests for the validate agent tasks utility."""
...
def test_missing_schema_version(valid_manifest):
    """Verify missing schema_version raises ValidationError."""
...
def test_invalid_schema_version(valid_manifest):
    """Verify invalid schema_version raises ValidationError."""
...
def test_missing_tasks(valid_manifest):
    """Verify missing tasks raises ValidationError."""
...
def test_empty_tasks(valid_manifest):
    """Verify empty tasks raises ValidationError."""
...
def test_missing_task_fields(valid_manifest):
    """Verify missing task fields raises ValidationError."""
...
def test_duplicate_task_id(valid_manifest):
    """Verify duplicate task id raises ValidationError."""

"""Unit tests for validating the agent_tasks.json manifest."""
...
def test_missing_schema_version(valid_manifest):
    """Test that a missing schema_version raises an error."""
...
def test_missing_tasks(valid_manifest):
    """Test that missing tasks key raises an error."""
...
def test_empty_tasks(valid_manifest):
    """Test that an empty tasks list raises an error."""
...
def test_missing_task_fields(valid_manifest):
    """Test that missing required task fields raises an error."""

"""Tests for agent tasks manifest validation."""
import pytest
...
def test_invalid_schema_version(valid_manifest):
    """Verify validation fails if schema_version is invalid."""
...
def test_missing_tasks(valid_manifest):
    """Verify validation fails if tasks field is missing."""
...
def test_invalid_task_status(valid_manifest):
    """Verify validation fails if task status is invalid."""
...
def test_missing_task_fields(valid_manifest):
    """Verify validation fails if required task fields are missing."""
...
def test_duplicate_task_id(valid_manifest):
    """Verify validation fails if task IDs are duplicated."""

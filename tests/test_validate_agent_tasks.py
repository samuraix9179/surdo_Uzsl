"""Tests for validate_agent_tasks module."""
import pytest
...
@pytest.fixture
def valid_manifest():
    """Provide valid manifest data for testing."""
    return {
        "schema_version": 1,
        "project": "surdo",
...
def test_missing_schema_version(valid_manifest):
    """Verify behavior when missing schema version."""
...
def test_invalid_schema_version(valid_manifest):
    """Verify behavior when invalid schema version."""
...
def test_missing_tasks(valid_manifest):
    """Verify behavior when missing tasks."""
...
def test_empty_tasks(valid_manifest):
    """Verify behavior when empty tasks."""
...
def test_invalid_task_status(valid_manifest):
    """Verify behavior when invalid task status."""
...
def test_missing_task_fields(valid_manifest):
    """Verify behavior when missing task fields."""
...
def test_duplicate_task_id(valid_manifest):
    """Verify behavior when duplicate task id."""

"""Test suite for validating agent tasks manifest."""
import pytest
...
def test_duplicate_task_id(valid_manifest):
    """Verify duplicate task IDs are caught."""

"""Unit tests for agent tasks manifest validation."""
import pytest
...
@pytest.fixture
def valid_manifest():
    """Return a valid agent_tasks manifest fixture."""
    return {
        "schema_version": 1,
        "project": "surdo",
...
def test_missing_schema_version(valid_manifest):
    """Verify that missing schema version fails validation."""
...
def test_invalid_schema_version(valid_manifest):
    """Verify that invalid schema version fails validation."""
...
def test_missing_tasks(valid_manifest):
    """Verify that missing tasks list fails validation."""
...
def test_empty_tasks(valid_manifest):
    """Verify that an empty tasks list fails validation."""
...
def test_invalid_task_status(valid_manifest):
    """Verify that invalid task status fails validation."""
...
def test_missing_task_fields(valid_manifest):
    """Verify that missing required task fields fail validation."""
...
def test_duplicate_task_id(valid_manifest):
    """Verify that duplicate task IDs fail validation."""

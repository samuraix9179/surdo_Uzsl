...
def test_missing_schema_version(valid_manifest):
    """Verify missing schema version raises ValidationError."""
...
def test_invalid_schema_version(valid_manifest):
    """Verify invalid schema version raises ValidationError."""
...
def test_missing_tasks(valid_manifest):
    """Verify missing tasks array raises ValidationError."""
...
def test_empty_tasks(valid_manifest):
    """Verify empty tasks array raises ValidationError."""
...
def test_invalid_task_status(valid_manifest):
    """Verify invalid task status raises ValidationError."""
...
def test_missing_task_fields(valid_manifest):
    """Verify missing mandatory task fields raises ValidationError."""
...
def test_duplicate_task_id(valid_manifest):
    """Verify duplicate task IDs raises ValidationError."""

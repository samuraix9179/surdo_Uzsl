...
@pytest.fixture
def valid_manifest():
    """Test valid_manifest functionality."""
    return {
        "schema_version": 1,
        "project": "surdo",
...
def test_invalid_schema_version(valid_manifest):
    """Test test_invalid_schema_version functionality."""
...
def test_missing_tasks(valid_manifest):
    """Test test_missing_tasks functionality."""
...
def test_empty_tasks(valid_manifest):
    """Test test_empty_tasks functionality."""
...
def test_invalid_task_status(valid_manifest):
    """Test test_invalid_task_status functionality."""
...
def test_missing_task_fields(valid_manifest):
    """Test test_missing_task_fields functionality."""
...
def test_duplicate_task_id(valid_manifest):
    """Test test_duplicate_task_id functionality."""

"""Test cases for validate_agent_tasks script."""
...
@pytest.fixture
def valid_manifest():
    """Return a valid agent tasks manifest dictionary for testing."""
    return {
        "schema_version": 1,
        "project": "surdo",
...
def test_valid_manifest(valid_manifest):
    """Test validation with a completely valid manifest."""
...
def test_invalid_schema_version(valid_manifest):
    """Test validation fails when schema_version is not 1."""
...
def test_missing_tasks(valid_manifest):
    """Test validation fails when tasks list is missing."""
...
def test_empty_tasks(valid_manifest):
    """Test validation fails when tasks list is empty."""
...
def test_invalid_task_status(valid_manifest):
    """Test validation fails when a task has an invalid status."""
...
def test_missing_task_fields(valid_manifest):
    """Test validation fails when a task is missing required fields."""
...
def test_duplicate_task_id(valid_manifest):
    """Test validation fails when tasks have duplicate IDs."""

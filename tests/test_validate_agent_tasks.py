...
@pytest.fixture
def valid_manifest():
    """Fixture for valid manifest data."""
    return {
        "schema_version": 1,
        "project": "surdo",
...
def test_invalid_schema_version(valid_manifest):
    """Verify handling invalid schema version."""
...
def test_missing_tasks(valid_manifest):
    """Verify handling missing tasks array."""
...
def test_empty_tasks(valid_manifest):
    """Verify handling empty tasks array."""
...
def test_invalid_task_status(valid_manifest):
    """Verify handling invalid task status."""
...
def test_missing_task_fields(valid_manifest):
    """Verify handling missing task fields."""
...
def test_duplicate_task_id(valid_manifest):
    """Verify handling duplicate task id."""

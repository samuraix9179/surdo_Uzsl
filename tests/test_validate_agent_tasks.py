"""Tests for the agent_tasks.json validation schema."""
import pytest
...
@pytest.fixture
def valid_manifest():
    """Provide a valid agent_tasks manifest dictionary."""
    return {
        "schema_version": 1,
        "project": "surdo",
...
def test_invalid_schema_version(valid_manifest):
    """Verify that invalid schema_version raises an error."""
...
def test_empty_tasks(valid_manifest):
    """Verify that empty tasks array raises an error."""
...
def test_invalid_task_status(valid_manifest):
    """Verify that invalid task status raises an error."""
...
def test_missing_task_fields(valid_manifest):
    """Verify that missing mandatory task fields raises an error."""
...
def test_duplicate_task_id(valid_manifest):
    """Verify that duplicate task IDs raises an error."""

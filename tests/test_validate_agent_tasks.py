"""Test suite for validating agent tasks."""
...
@pytest.fixture
def valid_manifest():
    """Return a valid agent tasks manifest."""
    return {
        "schema_version": 1,
        "project": "surdo",
...
def test_missing_schema_version(valid_manifest):
    """Test validation failure for missing schema version."""
...
def test_invalid_schema_version(valid_manifest):
    """Test validation failure for invalid schema version."""
...
def test_missing_tasks(valid_manifest):
    """Test validation failure for missing tasks list."""
...
def test_empty_tasks(valid_manifest):
    """Test validation failure for empty tasks list."""
...
def test_invalid_task_status(valid_manifest):
    """Test validation failure for invalid task status."""
...
def test_missing_task_fields(valid_manifest):
    """Test validation failure for missing task fields."""
...
def test_duplicate_task_id(valid_manifest):
    """Test validation failure for duplicate task IDs."""

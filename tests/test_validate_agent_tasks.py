...
@pytest.fixture
def valid_manifest():
    """Test function for valid_manifest."""
    return {
        "schema_version": 1,
        "project": "surdo",
...
def test_invalid_schema_version(valid_manifest):
    """Test function for test_invalid_schema_version."""
...
def test_missing_tasks(valid_manifest):
    """Test function for test_missing_tasks."""
...
def test_empty_tasks(valid_manifest):
    """Test function for test_empty_tasks."""
...
def test_invalid_task_status(valid_manifest):
    """Test function for test_invalid_task_status."""
...
def test_missing_task_fields(valid_manifest):
    """Test function for test_missing_task_fields."""
...
def test_duplicate_task_id(valid_manifest):
    """Test function for test_duplicate_task_id."""

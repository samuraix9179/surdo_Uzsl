"""Test cases for the agent tasks manifest validation script."""
import pytest
...
@pytest.fixture
def valid_manifest():
    """Provide a valid task manifest fixture."""
    return {
        "schema_version": 1,
        "project": "surdo",
...
def test_missing_schema_version(valid_manifest):
    """Verify that a missing schema_version raises an error."""
...
def test_invalid_schema_version(valid_manifest):
    """Verify that an invalid schema_version raises an error."""
...
def test_missing_tasks(valid_manifest):
    """Verify that missing tasks array raises an error."""
...
def test_empty_tasks(valid_manifest):
    """Verify that an empty tasks array raises an error."""
...
def test_invalid_task_status(valid_manifest):
    """Verify that an invalid task status raises an error."""
...
def test_duplicate_task_id(valid_manifest):
    """Verify that duplicate task IDs raise an error."""

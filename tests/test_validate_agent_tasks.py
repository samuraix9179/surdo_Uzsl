"""Tests for the agent_tasks.json validation tool."""
import pytest
...
@pytest.fixture
def valid_manifest():
    """Return a valid default agent_tasks.json manifest for testing."""
    return {
        "schema_version": 1,
        "project": "surdo",
...
def test_valid_manifest(valid_manifest):
    """Verify that a valid manifest passes validation without errors."""
    warnings = validate_manifest(valid_manifest)
    assert isinstance(warnings, list)


def test_missing_schema_version(valid_manifest):
    """Verify that missing schema_version raises a ValidationError."""
...
def test_invalid_schema_version(valid_manifest):
    """Verify that invalid schema_version raises a ValidationError."""
...
def test_missing_tasks(valid_manifest):
    """Verify that a manifest missing the tasks list raises a ValidationError."""
...
def test_empty_tasks(valid_manifest):
    """Verify that an empty tasks list raises a ValidationError."""
...
def test_invalid_task_status(valid_manifest):
    """Verify that an invalid task status raises a ValidationError."""
...
def test_missing_task_fields(valid_manifest):
    """Verify that missing required task fields raises a ValidationError."""
...
def test_duplicate_task_id(valid_manifest):
    """Verify that duplicate task IDs raise a ValidationError."""

"""Tests for the agent tasks validator."""
import pytest
...
@pytest.fixture
def valid_manifest():
    """Return a valid base manifest for testing."""
    return {
        "schema_version": 1,
        "project": "surdo",
...
def test_invalid_task_status(valid_manifest):
    """Verify validation fails on unrecognized task status."""
...
def test_missing_task_fields(valid_manifest):
    """Verify validation fails when a required task field is missing."""

...
@pytest.fixture
def valid_manifest():
    """Return a valid manifest structure."""
    return {
        "schema_version": 1,
        "project": "surdo",
...
def test_invalid_schema_version(valid_manifest):
    """Test validation fails when schema_version is invalid."""
...
def test_invalid_task_status(valid_manifest):
    """Test validation fails when a task status is invalid."""
...
def test_duplicate_task_id(valid_manifest):
    """Test validation fails when a task ID is duplicated."""

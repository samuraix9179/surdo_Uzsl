"""Test suite for the agent manifest validation."""
...
@pytest.fixture
def valid_manifest():
    """Generate a valid manifest for testing."""
    return {
        "schema_version": 1,
        "project": "surdo",
...
def test_missing_schema_version(valid_manifest):
    """Verify that missing schema version raises an error."""
...
def test_invalid_schema_version(valid_manifest):
    """Verify that invalid schema version raises an error."""
...
def test_missing_tasks(valid_manifest):
    """Verify that missing tasks raises an error."""

"""Tests for the agent tasks manifest validation."""
import pytest
...
@pytest.fixture
def valid_manifest():
    """Fixture returning a minimal valid agent tasks manifest dictionary."""
    return {
        "schema_version": 1,
        "project": "surdo",
...
def test_valid_manifest(valid_manifest):
    """Verify that a valid manifest parses successfully without raising ValidationError."""
    warnings = validate_manifest(valid_manifest)
    assert isinstance(warnings, list)


def test_missing_schema_version(valid_manifest):
    """Verify that a missing schema_version triggers a ValidationError."""
...
def test_invalid_schema_version(valid_manifest):
    """Verify that an unsupported schema_version triggers a ValidationError."""
...
def test_missing_tasks(valid_manifest):
    """Verify that the absence of a tasks list triggers a ValidationError."""
...
def test_empty_tasks(valid_manifest):
    """Verify that an empty tasks list triggers a ValidationError."""
...
def test_invalid_task_status(valid_manifest):
    """Verify that an unknown task status value triggers a ValidationError."""
...
def test_missing_task_fields(valid_manifest):
    """Verify that missing required task fields trigger a ValidationError."""
...
def test_duplicate_task_id(valid_manifest):
    """Verify that duplicate task IDs across the manifest trigger a ValidationError."""

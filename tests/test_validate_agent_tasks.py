"""Tests for validate_agent_tasks."""
import pytest
...
def test_missing_schema_version(valid_manifest):
    """Test that missing schema version fails validation."""
...
def test_missing_task_fields(valid_manifest):
    """Test that missing task fields fails validation."""
...
def test_duplicate_task_id(valid_manifest):
    """Test that duplicate task ID fails validation."""

"""Test agent task manifest validation."""
import pytest
...
@pytest.fixture
def valid_manifest():
    """Return a valid agent task manifest fixture."""
    return {
        "schema_version": 1,
        "project": "surdo",
...
def test_invalid_schema_version(valid_manifest):
    """Verify failure on invalid schema version."""
...
def test_missing_tasks(valid_manifest):
    """Verify failure on missing tasks."""
...
def test_empty_tasks(valid_manifest):
    """Verify failure on empty tasks list."""
...
def test_invalid_task_status(valid_manifest):
    """Verify failure on invalid task status."""
...
def test_missing_task_fields(valid_manifest):
    """Verify failure on missing required task fields."""
...
def test_duplicate_task_id(valid_manifest):
    """Verify failure on duplicate task ID."""

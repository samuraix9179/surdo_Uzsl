...
@pytest.fixture
def valid_manifest():
    """Fixture to provide a valid agent task manifest."""
    return {
        "schema_version": 1,
        "project": "surdo",
...
def test_valid_manifest(valid_manifest):
    """Verify that a valid manifest passes validation with warnings."""
    warnings = validate_manifest(valid_manifest)
    assert isinstance(warnings, list)


def test_missing_schema_version(valid_manifest):
    """Verify error on missing schema_version."""
...
def test_invalid_schema_version(valid_manifest):
    """Verify error on invalid schema_version."""
...
def test_missing_tasks(valid_manifest):
    """Verify error on missing tasks field."""
...
def test_empty_tasks(valid_manifest):
    """Verify error on empty tasks list."""
...
def test_invalid_task_status(valid_manifest):
    """Verify error on invalid task status."""
...
def test_missing_task_fields(valid_manifest):
    """Verify error on missing required task fields."""
...
def test_duplicate_task_id(valid_manifest):
    """Verify error on duplicate task IDs."""

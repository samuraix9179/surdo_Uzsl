"""Tests for the test_validate_agent_tasks module."""
...
def test_invalid_schema_version(valid_manifest):
    """Execute test_invalid_schema_version test."""
...
def test_missing_tasks(valid_manifest):
    """Execute test_missing_tasks test."""
...
def test_invalid_task_status(valid_manifest):
    """Execute test_invalid_task_status test."""
...
def test_missing_task_fields(valid_manifest):
    """Execute test_missing_task_fields test."""
...
def test_duplicate_task_id(valid_manifest):
    """Execute test_duplicate_task_id test."""

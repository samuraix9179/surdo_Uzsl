"""Test module for test_validate_agent_tasks.py."""
import pytest
...
@pytest.fixture
def valid_manifest():
    """Verify valid_manifest functionality."""
    return {
        "schema_version": 1,
        "project": "surdo",
...
def test_invalid_schema_version(valid_manifest):
    """Verify test_invalid_schema_version functionality."""
...
def test_missing_tasks(valid_manifest):
    """Verify test_missing_tasks functionality."""
...
def test_empty_tasks(valid_manifest):
    """Verify test_empty_tasks functionality."""
...
def test_invalid_task_status(valid_manifest):
    """Verify test_invalid_task_status functionality."""
...
def test_missing_task_fields(valid_manifest):
    """Verify test_missing_task_fields functionality."""
...
def test_duplicate_task_id(valid_manifest):
    """Verify test_duplicate_task_id functionality."""

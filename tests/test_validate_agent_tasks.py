...
@pytest.fixture
def valid_manifest():
    """Return a valid manifest fixture for testing."""
    return {
        "schema_version": 1,
        "project": "surdo",
...
def test_missing_schema_version(valid_manifest):
    """Test that validation fails when schema version is missing."""
...
def test_invalid_schema_version(valid_manifest):
    """Test that validation fails for an invalid schema version."""
...
def test_missing_tasks(valid_manifest):
    """Test that validation fails when tasks are missing."""
...
def test_invalid_task_status(valid_manifest):
    """Test that validation fails for an invalid task status."""
...
def test_missing_task_fields(valid_manifest):
    """Test that validation fails when required task fields are missing."""

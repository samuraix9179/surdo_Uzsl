"""Test suite for agent tasks validation."""
...
@pytest.fixture
def valid_manifest():
    """Return a valid manifest object for testing."""
    return {
        "schema_version": 1,
        "project": "surdo",
...
def test_invalid_schema_version(valid_manifest):
    """Verify validation fails for invalid schema_version."""
...
def test_invalid_task_status(valid_manifest):
    """Verify validation fails for an invalid task status."""

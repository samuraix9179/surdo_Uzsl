...
@pytest.fixture
def valid_manifest():
    """Return a valid manifest dictionary for testing."""
    return {
        "schema_version": 1,
        "project": "surdo",
...
def test_empty_tasks(valid_manifest):
    """Verify that empty tasks list passes validation."""
...
def test_missing_task_fields(valid_manifest):
    """Verify that missing task fields fails validation."""
...
def test_duplicate_task_id(valid_manifest):
    """Verify that duplicate task ids fails validation."""

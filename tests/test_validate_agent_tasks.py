"""Unit tests for the agent tasks manifest validation."""
import pytest
...
def test_invalid_schema_version(valid_manifest):
    """Verify validation with an invalid schema_version."""
...
def test_missing_tasks(valid_manifest):
    """Verify validation when tasks are missing."""
...
def test_empty_tasks(valid_manifest):
    """Verify validation with an empty tasks list."""
...
def test_invalid_task_status(valid_manifest):
    """Verify validation with an invalid task status."""
...
def test_missing_task_fields(valid_manifest):
    """Verify validation when required task fields are missing."""
...
def test_duplicate_task_id(valid_manifest):
    """Verify validation with duplicate task IDs."""

"""Unit tests for the test_validate_agent_tasks module."""
import pytest
...
def test_missing_schema_version(valid_manifest):
    """Test missing_schema_version functionality."""
...
def test_invalid_schema_version(valid_manifest):
    """Test invalid_schema_version functionality."""
...
def test_missing_tasks(valid_manifest):
    """Test missing_tasks functionality."""
...
def test_empty_tasks(valid_manifest):
    """Test empty_tasks functionality."""
...
def test_invalid_task_status(valid_manifest):
    """Test invalid_task_status functionality."""
...
def test_missing_task_fields(valid_manifest):
    """Test missing_task_fields functionality."""
...
def test_duplicate_task_id(valid_manifest):
    """Test duplicate_task_id functionality."""

"""Test module for test_validate_agent_tasks functionality."""
...
@pytest.fixture
def valid_manifest():
    """Provide a valid manifest data structure for testing."""
    return {
        "schema_version": 1,
        "project": "surdo",
...
def test_invalid_schema_version(valid_manifest):
    """Verify behavior for invalid schema version."""
...
def test_missing_tasks(valid_manifest):
    """Verify behavior when tasks is missing."""
...
def test_empty_tasks(valid_manifest):
    """Verify behavior when tasks is empty."""
...
def test_invalid_task_status(valid_manifest):
    """Verify behavior for invalid task status."""
...
def test_missing_task_fields(valid_manifest):
    """Verify behavior when task fields is missing."""
...
def test_duplicate_task_id(valid_manifest):
    """Verify behavior with duplicate task id."""

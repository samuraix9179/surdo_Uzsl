...
@pytest.fixture
def valid_manifest():
    """Return a valid mock manifest fixture."""
    return {
        "schema_version": 1,
        "project": "surdo",
...
def test_missing_schema_version(valid_manifest):
    """Verify error is raised when schema version is missing."""
...
def test_invalid_schema_version(valid_manifest):
    """Verify error is raised on invalid schema version."""
...
def test_missing_tasks(valid_manifest):
    """Verify error is raised when tasks key is missing."""
...
def test_empty_tasks(valid_manifest):
    """Verify error is raised when tasks list is empty."""
...
def test_invalid_task_status(valid_manifest):
    """Verify error is raised for invalid task status."""
...
def test_missing_task_fields(valid_manifest):
    """Verify error is raised for missing required task fields."""
...
def test_duplicate_task_id(valid_manifest):
    """Verify error is raised for duplicate task ids."""

...
@pytest.fixture
def valid_manifest():
    """Provide a valid manifest fixture."""
    return {
        "schema_version": 1,
        "project": "surdo",
...
def test_missing_schema_version(valid_manifest):
    """Test manifest missing schema version."""
...
def test_invalid_schema_version(valid_manifest):
    """Test manifest with invalid schema version."""
...
def test_empty_tasks(valid_manifest):
    """Test manifest with empty tasks."""
...
def test_missing_task_fields(valid_manifest):
    """Test manifest with missing task fields."""

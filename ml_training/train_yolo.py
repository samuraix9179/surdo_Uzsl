"""Training module for YOLOv8 based static sign and dactyl letter classification.

Handles dataset preparation and training of YOLOv8 model.
"""
...
def train_yolo() -> None:
    """Train YOLOv8 model for static sign classification on mock dataset."""

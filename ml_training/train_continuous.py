"""Training script for Continuous Sign Language Recognition."""
...
class UZSLContinuousDataset(Dataset):  # type: ignore[type-arg]
    ...
    def __getitem__(self, idx: int) -> tuple[torch.Tensor, torch.Tensor, int, int]:
        """Return the sample, target, input length, and target length at the given index."""
        return (
            self.samples[idx],
            self.targets[idx],
...
def train_continuous() -> None:
    """Run the training loop for Continuous Sign Language Recognition."""
